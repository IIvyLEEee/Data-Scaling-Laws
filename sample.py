...
class Sample:
    ...
    def sample(self):
        ...
        torch.save(
            qnn.state_dict(),
            "/home/liyixuan23/Data-Scaling-Laws/17-step-model/fquant_model_sw.ckpt",
        )
        torch.save(qnn, "/home/liyixuan23/Data-Scaling-Laws/17-step-model/fquant_model_sw.pth")
