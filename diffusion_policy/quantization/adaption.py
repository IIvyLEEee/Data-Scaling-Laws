...
from diffusion_policy.quantization.quan_layer import Weight_Quantizer, round_ste
...
class AdaRoundQuantizer(nn.Module):
    ...
    def __init__(self, uaq: Weight_Quantizer, weight_tensor: torch.Tensor, round_mode='learned_round_sigmoid'):
