...
from diffusion_policy.quantization.layer_recon_int4 import layer_reconstruction
from diffusion_policy.quantization.quan_block import BaseQuantBlock
from diffusion_policy.quantization.quan_layer_int4 import (
    Activation_Quantizer,
    QuantModule,
    Weight_Quantizer,
)
from diffusion_policy.quantization.quan_model_int4 import QuantModel
...
class Sample:
    ...
    def sample(self):
        ...
        torch.save(
            qnn.state_dict(),
            "/home/liyixuan23/Data-Scaling-Laws/17-step-model/fquant_model_4.ckpt",
        )
        torch.save(qnn, "/home/liyixuan23/Data-Scaling-Laws/17-step-model/fquant_model_4.pth")
